...
class BusinessUnitCreateValidationException extends \Exception implements ValidationExceptionInterface
{
     ...
     * @var string
     */
    private $type = 'BusinessUnitCreateValidationException';
