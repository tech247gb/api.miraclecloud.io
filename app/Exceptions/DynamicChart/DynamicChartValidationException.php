...
namespace App\Exceptions\DynamicChart;


use App\Contract\Exception\ValidationExceptionInterface;

class DynamicChartValidationException extends \Exception implements ValidationExceptionInterface
{
    /**
     * @var int $errorCode
     */
     ...
     * @var string
     */
    private $type = 'DynamicChartValidationException';
